...
export const register = () => {
      ...
      box({
        ...
        children: [
          ...
          box({
            ...
            children: 'SIGN UP',
            attr: {
              class: 'fontm text-xl font-bold mt-10 w-70 p-4 bg-slate-900 rounded-xl text-white',
              style: 'background: var(--Primary, #242424);box-shadow: 0px 10px 20px 0px rgba(48, 48, 48, 0.25);',
  ...
  //<div class:'te'></div>
  const regesterie=handelregesterform()
  console.log(regesterie)
...
import { handleRegisterForm } from "./regstry";
        ...
        children: [
          ...
          box({
            ...
            [
              ...
              box({element:'img',attr:{src:'/public/pixar/group.jpg'}})
              ,
              box({element:'div',attr:{style:'width: 8.5625rem;height: 0.0625rem;border-radius: 0.125rem;border: 1px solid #000;background: var(--Gray-4, #BDBDBD);'}}),
            ]
            ,
          ...
          box({element: 'button',children:'SIGN UP',attr: {class: 'fontm text-xl font-bold mt-10 w-70 p-4 bg-slate-900 rounded-xl text-white',style:'background: var(--Primary, #242424);box-shadow: 0px 10px 20px 0px rgba(48, 48, 48, 0.25);',onclick:handleRegisterForm}}),]
          //button

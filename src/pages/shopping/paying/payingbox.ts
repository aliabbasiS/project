import { checkoutrender, endingrender, standshopcardrender } from "../../../Routing/routes";
        ...
        box({
          ...
          children: [
            ...
            ,box({element:'div',children:[
              ...
              ,box({element:'button',children:'Check out ',attr:{class:'w-full h-20 bg-slate-900 text-white text-2xl rounded-xl',style:'box-shadow: 0px 10px 20px 0px rgba(48, 48, 48, 0.25);',onclick:checkoutrender}})

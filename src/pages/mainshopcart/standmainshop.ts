    ...
    children: [
      box({
        ...
        children: [
            ...
            box({element:'div',children:[
                box({element:'div',children:[
                    ...
                    box({
                      ...
                      attr: {
                        src:'public/pixar/shops_stand.jpg',
                        class:'object-fill rounded-bl-[50px]'
                        
                      },   
                  }),
                ],attr:{class:'h-full flex w-4/5 items-end justify-end '}}),
            ...
            //main topics
            box({element:'h1',children:'Minimal Stand',attr:{class:'text-2xl font-medium fontg mt-5 px-4 '}})
            ,//price and numbers
            box({element:'div',children:[
                box({element:'h1',children:'$ 50' ,attr:{class:'fontn text-3xl font-bold  '}})
                ,box({element:'div',children:[
